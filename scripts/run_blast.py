## my way grosser pipeline.

#### Be sure that the submission script (array job) reflects the number of seeds!!
# Can edit internal options as needed.
...
## Prepare blastin file
sge = sys.argv[1] # which index we are running
index = int(sge)
if index == 42:
	index = 0
