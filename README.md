...
3. [ML partitioned-phylogeny](./analysis/phylogenies/final_trees/RAxML_bipartitions.struc_masked_part) created with structurally-informed *masked* alignment, in newick format with branch lengths and bootstrap support included.
