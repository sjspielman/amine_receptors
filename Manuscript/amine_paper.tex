...
\bibitem[Altschul et~al., 1997]{psiblast}
...
\newblock Gapped {BLAST} and {PSI-BLAST}: a new generation of protein database
  search programs.
\newblock {\em Nucleic Acids Res}, 25:3389 -- 3402.

\bibitem[Amemiya et~al., 2013]{coelacanth2013}
...
\newblock The african coelacanth genome provides insights into tetrapod
  evolution.
\newblock {\em Nature}, 496:311 -- 316.

\bibitem[Anbazhagan et~al., 2010]{Anbazhagan2010}
...
\newblock {\em J Biomol Struct Dyn}, 27(5):581 -- 598.

\bibitem[Bockaert and Pin, 1999]{BockaertPin1999}
Bockaert, J. and Pin, J.~P. (1999).
\newblock Molecular tinkering of {G} protein-coupled receptors: an evolutionary
  success.
\newblock {\em EMBO J}, 18(7):1723 -- 1729.

\bibitem[Callier et~al., 2003]{Callieretal2003}
...
\newblock {\em Biol Cell}, 95(7):489 -- 502.

\bibitem[Chang et~al., 2012]{Chang2012}
...
\newblock Accurate multiple sequence alignment of transmembrane proteins with
  {PSI-Coffee}.
\newblock {\em BMC Bioinformatics}, 13(Suppl 4):S1.

\bibitem[Eddy, 1998]{hmmer}
Eddy, S. (1998).
\newblock Profile hidden {Markov} models.
\newblock {\em Bioinformatics}, 14:755 -- 763.

\bibitem[Evers et~al., 2005]{Eversetal2005}
...
\newblock Virtual screening of biogenic amine-binding {G}-protein coupled
  ...
  screening protocols.
\newblock {\em J Med Chem}, 48(17):5448 -- 5465.

\bibitem[Franzosa et~al., 2013]{FranzosaXueXia2013}
...
\newblock {\em Genome Biol Evol}, 5:734 -- 744.

\bibitem[Fredriksson et~al., 2003]{Fredrikssonetal2003}
...
\newblock {\em Mol Pharmacol}, 63(6):1256 -- 1272.

\bibitem[Gloriam et~al., 2005]{Gloriametal2005}
...
\newblock {\em Mol Phylogenet Evol}, 35(2):470 -- 482.

\bibitem[Hashiguchi and Nishida, 2007]{Hashiguchi2007}
...
\newblock {\em Mol Biol Evol}, 24(9):2099 -- 2107.

\bibitem[Hill and Deane, 2012]{Hill2012}
Hill, J.~R. and Deane, C.~M. (2012).
\newblock {MP-T}: improving membrane protein alignment for structure
  prediction.
\newblock {\em Bioinformatics}, 29(1):54--61.

\bibitem[Hwang et~al., 2013]{Hwangetal2013}
...
\newblock {\em Mol Biol Evol}, 30(5):1119 -- 1130.

\bibitem[Ishiguro, 2004]{Ishiguro2004}
Ishiguro, M. (2004).
\newblock Ligand-binding modes in cationic biogenic amine receptors.
\newblock {\em ChemBioChem}, 5(9):1210 -- 1219.
...
\newblock {\em Mol Biol Evol}, 29:1125 -- 1139.

\bibitem[Julenius and Pedersen, 2006]{Julenius2006}
Julenius, K. and Pedersen, A.~G. (2006).
\newblock Protein evolution is faster outside the cell.
\newblock {\em Mol Biol Evol}, 23:2039 -- 2048.

\bibitem[Kakarala and Jamil, 2014]{KakaralaJamil2014}
Kakarala, K.~K. and Jamil, K. (2014).
\newblock Sequence-structure based phylogeny of {GPCR} class {A} rhodopsin
  receptors.
\newblock {\em Mol Phylogenet Evol}, 74(C):66 -- 96.

\bibitem[Katoh and Standley, 2013]{mafftv7}
...
\newblock {\em Mol Biol Evol}, 30:772 -- 780.

\bibitem[Krishnan et~al., 2012]{Krishnan2012}
...
\newblock {\em PLoS ONE}, 7(1):e29817.

\bibitem[Kristiansen, 2004]{Kristiansen2004}
Kristiansen, K. (2004).
...
\newblock {\em Pharmacol Therapeut}, 103(1):21 -- 80.

\bibitem[Lagerstrom and Schioth, 2008]{Lagerstrom2008}
...
\newblock {\em Nat Rev Drug Discov}, 7:339 -- 357.

\bibitem[Le and Gascuel, 2008]{LG}
Le, S. and Gascuel, O. (2008).
\newblock An improved general amino acid replacement matrix.
\newblock {\em Mol Biol Evol}, 25:1307 -- 1320.

\bibitem[Lindemann et~al., 2005]{Lindemann2005}
...
\newblock {\em Genomics}, 85(3):372 -- 385.
...
\newblock {\em Science}, 320:1632 -- 1635.

\bibitem[Luan et~al., 2013]{Luanetal2013}
...
\newblock {\em Mol Phylogenet Evol}, 66:748 -- 756.
...
\newblock {\em Trends in Pharmacol Sci}, 33(5):249 -- 260.

\bibitem[Morrison, 2008]{Morrison2008}
Morrison, D.~A. (2008).
\newblock A framework for phylogenetic sequence alignment.
\newblock {\em Plant Syst Evol}, 282(3-4):127 -- 149.

\bibitem[Nichols and Nichols, 2008]{Nichols2008}
Nichols, D.~E. and Nichols, C.~D. (2008).
\newblock Serotonin receptors.
\newblock {\em Chemical Reviews}, 108(5):1614 -- 1641.

\bibitem[Oberai et~al., 2009]{Oberai2009}
...
\newblock {\em Proc Natl Acad Sci USA}, 106:17747 -- 17750.

\bibitem[Ogden and Rosenberg, 2006]{Ogden2006}
Ogden, T.~H. and Rosenberg, M.~S. (2006).
\newblock Multiple sequence alignment accuracy and phylogenetic inference.
\newblock {\em Syst Biol}, 55(2):314 -- 328.

\bibitem[O'Sullivan et~al., 2004]{3dcoffee}
O'Sullivan, O., Suhre, K., Abergel, C., Higgins, D.~G., and Notredame, C.
  (2004).
\newblock {3DCoffee}: Combining protein sequences and structures within
  multiple sequence alignments.
\newblock {\em J Mol Biol}, 340:385 -- 395.

\bibitem[Pei et~al., 2008]{promals3d}
Pei, J., Kim, B.~H., and Grishin, N.~V. (2008).
\newblock {PROMALS3D}: a tool for multiple protein sequence and structure
  alignments.
\newblock {\em Nuc Acids Res}, 36(7):2295 -- 2300.

\bibitem[Pruitt et~al., 2013]{refseq}
...
\newblock {RefSeq}: an update on mammalian reference sequences.
\newblock {\em Nucleic Acids Res}, 42(D1):D756--D763.

\bibitem[Roeder, 2005]{Roeder2005}
Roeder, T. (2005).
\newblock Tyramine and octopamine: Ruling behavior and metabolism.
\newblock {\em Annual Review of Entomology}, 50(1):447 -- 477.

\bibitem[Schoneberg et~al., 2004]{Schoneberg2004}
...
\newblock {\em Pharmacol Ther}, 104:173 -- 206.
...
\newblock {\em J Mol Evol}, 76(3):172 -- 182.
...
\bibitem[Stamatakis, 2014]{raxml}
Stamatakis, A. (2014).
\newblock {RAxML Version 8}: A tool for phylogenetic analysis and post-analysis
  of large phylogenies.
\newblock {\em Bioinformatics}, 30(9):1312 -- 1313.

\bibitem[St{\"a}ubert et~al., 2010]{Staubert2010}
...
\newblock {\em PLoS ONE}, 5(6):e11133.

\bibitem[St{\"a}ubert et~al., 2013]{Staubert2013}
...
\bibitem[Stevens and Arkin, 2001]{Stevens2001}
Stevens, T.~J. and Arkin, I.~T. (2001).
\newblock Substitution rates in alpha-helical transmembrane proteins.
\newblock {\em Prot Sci}, 10:2507 -- 2517.

\bibitem[Sundstrom et~al., 2010]{Sundstrom2010}
...
\newblock {\em PLoS One}, 5:e10512.

\bibitem[Tourasse and Li, 2000]{Tourasse2000}
Tourasse, N.~J. and Li, W.-H. (2000).
\newblock Selective constraints, amino acid composition, and the rate of
  protein evolution.
\newblock {\em Mol Biol Evol}, 17:656 -- 664.

\bibitem[Vassilatis et~al., 2003]{Vassilatis2003}
Vassilatis, D.~K. et~al. (2003).
\newblock The {G} protein-coupled receptor repertoires of human and mouse.
\newblock {\em Proc Natl Acad Sci USA}, 100(8):4903 -- 4908.

\bibitem[Warnow, 2012]{Warnow2012}
Warnow, T. (2012).
\newblock Standard maximum likelihood analyses of alignments with gaps can be
  statistically inconsistent.
\newblock {\em PLoS Curr}, 4:RRN1308.

\bibitem[Widmark et~al., 2011]{Widmark2011}
...
\newblock Differential evolution of voltage-gated sodium channels in tetrapods
  and teleost fishes.
\newblock {\em Mol Biol Evol}, 28:859 -- 871.

\bibitem[Wistrand et~al., 2006]{Wistrand2006}
...
\newblock {\em Prot Sci}, 15(3):509 -- 521.

\bibitem[Wong et~al., 2008]{Wong2008}
Wong, K.~M., Suchard, M.~A., and Huelsenbeck, J.~P. (2008).
\newblock Alignment uncertainty and genomic analysis.
\newblock {\em Science}, 319(5862):473 -- 476.

\bibitem[Yamamoto et~al., 2013]{Yamamotoetal2013}
...
\newblock Evolution of dopamine receptor genes of the {D1} class in
  vertebrates.
\newblock {\em Mol Biol Evol}, 30(4):833 -- 843.

\bibitem[Yegorov and Good, 2012]{YegorovGood2012}
...
\newblock {\em PLoS ONE}, 7(3):e32923.
