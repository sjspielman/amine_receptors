...
\begin{figure}[htbp]
	\centerline{\includegraphics[width=6in]{figures/domains_naive_struc.png}}
	\caption{\label{domains} Graphical representation of a subset of the naive and structurally-curated biogenic amine receptor MSAs. Each image displays 128 MSA rows focused specifically on the MSA section containing the seven TM domains. The naive MSA subset contains 2500 columns, whereas the structurally-curated MSA subset contains 1300 columns. Dark blue rectangles represent predicted extracellular residues, red rectangles represent predicted TM residues, lighter blue rectangles represent predicted intracellular residues, and gray represents MSA gaps. The bottom bar below each MSA figure represents the consensus domain structure.}
\end{figure}
