...
df_aln_s=data.frame(x1=aln_s$x + 1950, x2=aln_s$x + 1970, y1=aln_s$y, y2=aln_s$y + 20, t=aln_s$domain)
df_cons_s=data.frame(x1=cons_s$x + 1950, x2=cons_s$x + 1970, y1=cons_s$y - 12, y2=cons_s$y - 2, t=cons_s$domain)
...
draw_text("Naive MSA", x = 880,  y = 160, size = 35, fontface = "bold") + 
draw_text("Structural MSA", x = 2400, y = 160, size = 35, fontface = "bold") +
geom_segment(aes(x = -60, y = 0, xend = -60, yend = 148), size = 2) +
draw_text("1", x  = -100, y = 5, size = 22, fontface = "bold") + 
draw_text("50", x  = -100, y = 55, size = 22, fontface = "bold") + 
draw_text("100", x  = -110, y = 105, size = 22, fontface = "bold") + 
draw_text("Sequence", angle = 90, x = -180, y = 75, size = 28, fontface = "bold") +
draw_text("Site", x = 900,  y = -20, size = 28, fontface = "bold") + 
draw_text("Site", x = 2420, y = -20, size = 28, fontface = "bold") +
