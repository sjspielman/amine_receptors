...
######################################################################
def main(infile, aa_outfile, nuc_outfile, map_outfile, protid_regexp, startat):
    ...
    out_aa = open(aa_outfile, 'a')
    out_nuc = open(nuc_outfile, 'a')
    out_map = open(map_outfile, 'a')
...
startat     = int(sys.argv[5])

protid_regexp = "^([XN]P_\d+\.\d)_.+$"
main(aa_infile, aa_outfile, nuc_outfile, map_outfile, protid_regexp, startat)
