...
######################################################################
def main(infile, aa_outfile, nuc_outfile, map_outfile, ncbi_dir):
	...
	for record in seqs:
		...
		record = SeqIO.read(ncbi_dir + prot_id + '.gb', 'gb')
...
ncbi_dir = sys.argv[5]
main(aa_infile, aa_outfile, nuc_outfile, map_outfile, ncbi_dir)
