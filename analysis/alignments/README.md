...
__naive__/     
Contains protein and nucleotide *naive* MSAs, in FASTA format. 
...
__structural__/     
Contains protein and nucleotide *structurally-informed* MSAs, in FASTA format. 
 ...
 4. __domain_consensus.txt__ contains simply the string showing the structurally-informed MSA's consensus domain structure.
